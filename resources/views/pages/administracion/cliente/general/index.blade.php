...
<div class="card card-custom gutter-b example example-compact">
    <div class="card-header justify-content-left">
        <h3 class="card-title">Datos Generalessssssss</h3>
    ...
    <!--begin::Form-->
    <form action="{{ route('administracion.general2.store') }}" method="post" id="form">
        @if ( $data->tipo == 'update' )
...
{{-- Scripts Section --}}
<script src="{{ asset('scripts/administracion/cliente/general/index.js') }}" type="text/javascript"></script>
